...
export default function MarketsPage() {
  return (
    <div className="mx-auto w-full max-w-3xl flex-1 px-6 pb-16 pt-10">
      <div className="pb-8">
        <p className="text-[11px] uppercase tracking-[0.35em] text-[color:var(--text-muted)]">Odds · Play</p>
        ...
        <p className="mt-3 max-w-xl text-base leading-relaxed text-[color:var(--text-secondary)]">
          Create a round, call YES or NO while it is Open, then let the Scheduler settle it. All reads come from{" "}
